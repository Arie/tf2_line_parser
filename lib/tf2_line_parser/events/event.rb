  ...
  module Events
    ...
    class Event
      ...
      def self.types
        ...
        @types ||= [Damage, Heal, PickupItem, Assist, Kill, PointCapture, ChargeDeployed, MedicDeath, Say, TeamSay, RoundWin, CurrentScore, RoundStart, Domination, Revenge, ConsoleSay, MatchEnd, FinalScore, RoundStalemate, Unknown]
      end
